        ...
        {["A", "B", "C", "D"].map((letter, oIdx) => {
          ...
          return (
            <div key={letter} className="flex items-center gap-2">
              <span className="flex items-center justify-center w-7 h-7 bg-[color:var(--accent-light)] text-[color:var(--accent)] rounded-full font-semibold text-xs shrink-0">
                {letter}
              </span>
              <input
                type="text"
...
const QuizForm = ({
  ...
  const addQuestion = () => {
    setQuestions([...questions, { text: "", optionA: "", optionB: "", optionC: "", optionD: "", correctAnswer: "A", marks: 10 }]);
  };
